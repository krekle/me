let resumeData = {
  content: {
    ...
    cv_promo: "Mer utfyllende informasjon i fullstendig CV, tilgjengelig på flere språk, ",
    cv_link: "pdf her",
    ...
    lead: "Ta gjerne kontakt på epost eller på linkedin."
  },
  socialLinks: [
    {
      name: "linkedin",
  ...
  projects: [
    ...
    },
    {
      ...
      ProjectDescription:
        "Avinor et behov for å bistå de ansatte ved informasjonsskrankene på sine flyplasserog så at de mest stilte spørsmålene kunne løses digitalt, det ville redusere ressursbehovet ved informasjonsskrankene.  Kristian var del av team som skulle løse dette problemet, første fase var å sette opp en digital informasjonskiosk for Oslo Lufthavn. I prosjektets fase 2 ble løsningen utrullet på andre norske flyplasser. ",
      Contribution:
        "Kristian jobbet i et lite smidig team bestående av tre utviklere og en designer som beveget seg hurtig, med hypping feedback fra kunde og sluttbrukere. Løsningen bestod av webapplikasjoner i React, backend i C# ASP. NET Core og brukte flere tjenester fra Azure til pålogging, datapersistering, og deployment.",
      Bullets: [
        "Utviklet C# ASP.NET Core backend med Entity Framework mot Azure CosmosDB",
      ...
      Roles: [
        {
          Name: "Fullstackutvikler",
          Description:
            "Kristian jobbet med implementering av løsningen basert på kundens spesifikasjon i samarbeid med UX. Han kodet i alle lagene av løsningen: Database, C#, React og i Azure. Han jobbet med resten av teamt i å utarbeide systemarkitektur og design av applikasjonene.",
        },
      ],
      Tech: [
        "React",
    ...
    },
    {
      ...
      Bullets: [
        ...
        "Utviklet ETL pipelines i Databricks mot AWS DynamoDB og AWS Redshift til prosessering av store datamengder ",
        "Utarbeidet løsningsdesign for systemets arkitektur som ble presentert og akseptert i Arkitekturforum ",
        "Utviklet webapp i React for visualisering av sensordata og vedlikeholdsbehov",
        "Besøkte jevnlig verkstedhallen for å feilsøke systemet på vognen ",
      ],
      Roles: [
        {
      ...
      Roles: [
        {
          Name: "Fullstackutvikler",
          Description:
            "Han jobbet med å utvikle modeller for IVO, itegrasjoner mot kildedata og oppsett av server samt CI/CD mot maskinjer i amazon. Videre jobbet han med datamodeller og optimeringsalgoritmer for løsningen. I en iterativ prosess bidro Kristian til å utvikle og teste hypoteser og modeller.",
        },
        {
          Name: "Arkitekt",
          Description:
      ...
      Roles: [
        {
          Name: "Fullstackutvikler",
          Description:
            "Som utvilkler jobbet Kristian med integrasjoner mot nødvendig kildedata i GraphQL, oppsett av Bot Framework og design av card som ble brukt til å visualisere oppskrifter i chat-dialogene.",
        },
      ],
      Tech: [
        "node.js",
      ...
      Roles: [
        {
          Name: "Utvikler",
          Description:
            "Som utvikler jobbet Kristian med frontend i Angualr.js og bakenforliggende API i Java JSF",
        },
      ],
      Tech: [
        "Java",
    ...
    },
    {
      ...
      ProjectDescription:
        "Direktoratet for forvaltning og ikt (Difi) tar hvert år inn sommerstudenter med relevant pågående utdannelse i fra data-linjer på universiter og høyskoler i Norge til “Dificamp”.  Dificamp gir utviklerne i difi ekstra kapasitet til å teste ut nye teknologi eller til å jobbe med løsninger som det ellers ikke er tid til. ",
      Contribution:
        "Kristian jobbet sommeren 2014 hos Difi i Leikanger. Han jobbet på tre forskjellige applikasjoner og systemer i løpet av 2 måneder; 'E-læringsplatform i PHP Moodle for kurs og elæring til bruk i staten', 'Indeksering og tilgjengeliggjøring av Doffin-data (data over offentlig anbud) i Elasticsearch og Spring boot' og 'Android app for inkludering av ID-porten MinId som en eID'",
      Bullets: [
      ...
      Roles: [
        {
          Name: "Utvikler",
          Description:
            "Som utvikler jobbet Kristian alle lagene i de forskjellige løsningene. SpringBoot backends, Android applikasjoner og infrastrukturoppgaver i Elasticsearch",
        },
      ],
      Tech: [
        "elastic search",
  ...
  education: [
    {
      ...
      specialization:
        "Master of Science (MSc), Informatikk, Kunstig Intelligens",
      MonthOfPassing: "Juni",
      YearOfPassing: "2017",
  ...
  work: [
    ...
    },
    {
      ...
      YearOfLeaving: "Mai 2020",
      Achievements:
        "Gjennom sin jobb hos bouvet var Kristian utleid på flere prosjekter hos kunder som: Tine, Sporveien og Avinor",
    },
    {
      CompanyName: "Visma Software Autopay",
      specialization: "Systemutvikler",
      MonthOfLeaving: "Juni 2015",
      YearOfLeaving: " - Juni 2017",
      Achievements:
        "Kristian jobbet deltid hos Visma mens han studerte og fulltid på sommerne siden 2015.",
    },
    {
      CompanyName: "Direktoratet for forvaltning og IKT (Difi)",
      specialization: "Systemutvikler",
      YearOfLeaving: " - August 2014",
      MonthOfLeaving: "Juni 2014",
